...
def rpsls(player_choice):
    ...
    while player_choice_number==name_to_number('石头'):
        print('您的选择为：'+number_to_name(0)+','+'计算机的选择为：'+number_to_name(a))
    ...
    while player_choice_number==name_to_number('史波克'):
        print('您的选择为：'+number_to_name(1)+','+'计算机的选择为：'+number_to_name(a))
        if player_choice_number==a:
            print('您和计算机出的一样呢')
        if a==4 or a==0:
            print('您赢了')
    ...
    while player_choice_number==name_to_number('纸'):
        print('您的选择为：'+number_to_name(2)+','+'计算机的选择为：'+number_to_name(a))
        if player_choice_number==a:
            print('您和计算机出的一样呢')
        if a==1 or a==0:
            print('您赢了')
    ...
    while player_choice_number==name_to_number('蜥蜴'):
        print('您的选择为：'+number_to_name(3)+','+'计算机的选择为：'+number_to_name(a))
        if player_choice_number==a:
            print('您和计算机出的一样呢')
        if a==1 or a==2:
            print('您赢了')
...
print("请输入您的选择:")
choice_name=input()
if choice_name=='石头' or '剪刀' or '纸' or '蜥蜴' or '史波克':
